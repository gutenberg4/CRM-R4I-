    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown active"><a href="#"><span class="iconfa-pencil"></span>Furnizori</a>
                    <ul>
...
<div id="page-heading"><h1>Adaugă Furnizor</h1></div>
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
		<form  action="../../BusinessLogic/validare_furnizor.php" method="post">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top">Nume companie furnizor:</th>
			<td><input type="text" class="inp-form" name="nume" /></td>
		</tr>
		<tr>
	...
	<tr>
		...
		<tr>
			<th valign="top">Adresă furnizor:</th>
			<td><textarea rows="" cols="" class="form-textarea" name="adresa"></textarea>
			</td>
		</tr>
	<tr>
		<th>&nbsp;</th>
