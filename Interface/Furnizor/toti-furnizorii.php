			...
			?>
				...
				<tr>
				 <?php $sort = array_get($_GET, 'sort'); ?>
					<th class="table-header-repeat line-left minwidth-1 <?php if ($sort == 'nume') echo "sort"; ?>"><a href="?sort=nume">Nume companie</a></th>
					...
					<th class="table-header-repeat line-left <?php if ($sort == 'cifra_afaceri') echo "sort"; ?>"><a href="?sort=cifra_afaceri">Cifra afaceri</a></th>
					...
					<th class="table-header-options line-left"><a href="">Opțiuni</a></th>
				</tr>
				<?php

error_reporting(E_ALL);

                $result = get_entries_for_current_page('furnizori');
			//	echo mysql_errno() . ": " . mysql_error() . "\n";		
				...
				<tr>
					...
					<a href="editareFurnizor.php?id_furnizor=<?php echo $row['id_furnizor']?>" title="Editare" id="<?=$row['id_furnizor']?>" class="icon-1 info-tooltip"></a>
					<a href="../../BusinessLogic/sterge_furnizor.php?id_furnizor=<?php echo $row['id_furnizor']?>" title="Șterge" id="<?=$row['id_furnizor']?>" class="icon-2 info-tooltip">
					</a>
					</td>
				</tr>
				<?php 
