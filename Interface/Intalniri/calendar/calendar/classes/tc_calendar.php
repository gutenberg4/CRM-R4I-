...
//isset($_REQUEST["date1"]) ? $_REQUEST["date1"] : "";	
	$this->day = $day;
	$this->month = $month;
	$this->year = $year;
	}
	...
	function writeDay(){
		...
		echo("<option value=\"00\"".($this->rtl ? " dir=\"rtl\"" : "").">Ziua</option>");
	...
	function writeMonth(){
		...
		echo("<option value=\"00\"".($this->rtl ? " dir=\"rtl\"" : "").">Luna</option>");
	...
	function writeYear(){
		...
		echo("<option value=\"0000\"".($this->rtl ? " dir=\"rtl\"" : "").">An</option>");
	...
	function getMonthNames(){
		return array("Ianuarie", "Februarie", "Martie", "Aprilie", "Mai", "Iunie", "Iulie", "August", "Septembrie", "Octobrie", "Noiembrie", "Decembrie");
	}
