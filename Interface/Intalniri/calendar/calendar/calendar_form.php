...
<title>TriConsole.com - Free PHP Calendar Date Picker</title>
    ...
    <div id="calendar-container">
        ...
        <div id="calendar-footer">
          <div class="btn">
			...
			?><a href="javascript:move('<?php echo(str_pad($previous_month, 2, "0", STR_PAD_LEFT));?>', '<?php echo($previous_year);?>');">
			<img src="images/btn_<?php echo($rtl ? "next" : "previous"); ?>.png" width="16" height="16" border="0" alt="Previous" title="Previous" /></a>
			<?php
            }else echo("&nbsp;");
            ?>
            </div>
            ...
            <div style="margin-left: 30px; margin-right: 30px;" align="center">
            	<a href="javascript:today();" class="txt">Astazi</a>
                <?php
				if($sld>0 && $slm>0 && $sly>0){
				?> | <a href="javascript:unsetValue();" class="txt">Deselectati ziua</a>
                <?php
				}
				?>
            </div>
