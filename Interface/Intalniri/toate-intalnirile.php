			...
			?>
				...
				<tr>
				 <?php $sort = array_get($_GET, 'sort'); ?>
					<th class="table-header-repeat line-left minwidth-1 <?php if ($sort == 'client') echo "sort"; ?>"><a href="?sort=client">Client</a>	</th>
					...
					<th class="table-header-repeat line-left <?php if ($sort == 'resp_sec') echo "sort"; ?>"><a href="?sort=resp_sec">Responsabil secundar</a></th>
					<th class="table-header-repeat line-left <?php if ($sort == 'date1') echo "sort"; ?>"><a href="?sort=date1">Data</a></th>
...
error_reporting(E_ALL);
                ...
                $result = get_entries_for_current_page('intalniri');
			//	echo mysql_errno() . ": " . mysql_error() . "\n";		
				...
				<tr>
					...
					<a href="editareIntalnire.php?id_intalnire=<?php echo $row['id_intalnire']?>" title="Editare" id="<?=$row['id_intalnire']?>" class="icon-1 info-tooltip"></a>
					<a href="../../BusinessLogic/sterge_intalnire.php?id_intalnire=<?php echo $row['id_intalnire']?>" title="Șterge" id="<?=$row['id_intalnire']?>" class="icon-2 info-tooltip">
					</a>
					</td>
				</tr>
				<?php 
