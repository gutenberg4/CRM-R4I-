...
<div id="page-heading"><h1>Editare Client</h1></div>
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
		<form action="../../BusinessLogic/editare_client.php" method="post">
			<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
				<?php
				error_reporting(E_ALL);
require_once '../../config.php';
				//require_once '../config.php';
				$result = mysql_query("SELECT * FROM clienti WHERE id_client=".$_GET['id_client']."");
			//	echo mysql_errno() . ": " . mysql_error() . "\n";		
				...
				<tr>
					...
					<td><input type="text" class="inp-form" name="nume_companie" value="<?=$row['nume_companie']?>"/>
					</td>
				...
				<tr>
					...
					<td style="padding-right: 150px"><input type="text" class="inp-form" name="adresa" value="<?=$row['adresa']?>"/></td>
					<input type="hidden" class="inp-form" name="id_client" hidden value="<?=$row['id_client']?>"/>
				</tr>
				<?php 
				}
				?>
