    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown active"><a href="#"><span class="iconfa-briefcase"></span>Clienti</a>
                    <ul>
...
<div id="page-heading"><h1>Adaugă Client</h1></div>
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
		<form action="../../BusinessLogic/validare_client.php" method="post">
			<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
			
				<tr>
					<th valign="top">Nume companie:</th>
					<td><input type="text" class="inp-form" name="nume_companie"/>
					</td>
				...
				<tr>
					...
					<td style="padding-right: 150px"><input type="text" id="inputString" onkeyup="lookup(this.value);" onblur="fill();" class="inp-form" name="domeniu"/>
					<div class="suggestionsBox" id="suggestions" style="display: none;">
				<div class="suggestionList" id="autoSuggestionsList">
					&nbsp;
				</div>
			</div>
					<a title="Domeniul de activitate al companiei respective." class="icon-1 info-tooltip"></a>
					</td>
				...
				<tr>
					...
					<td><input type="text" class="inp-form" name="website"/></td>
					
				</tr>
				<tr>
					<th valign="top">Cifra afaceri:</th>
					<td style="padding-right: 150px"><input type="text" class="inp-form" name="cifra_afaceri"/>
					...
					<td style="padding-right: 150px"><input type="text" class="inp-form" name="persoana_contact"/>
				...
				<tr>
					...
					<td style="padding-right: 150px"><input type="text" class="inp-form" name="telefon"/>
				...
				<tr>
					...
					<td style="padding-right: 150px"><input type="text" class="inp-form" name="email"/>
					...
					<td><textarea rows="4" cols="" class="form-textarea" name="adresa"></textarea></td>
	...
	<div id="related-activities">
		...
		<div id="related-act-bottom">
			...
			<div id="related-act-inner">
				...
				<div class="right">
					<h5>Vezi toți clienții.</h5>
					Pentru a vedea toți clienții, click pe următorul link:
					<ul class="greyarrow">
						<li><a href="toti-clientii.php">Click aici</a></li> 
					</ul>
				</div>
