	...
	<tr>
		...
		<div id="content-table-inner">
			...
			?>
				...
				<tr>
					<td class="blue-left">Bine ai revenit!
					<?php
/*require_once '../../config.php';					
					echo '.$_POST['nume'].';*/
					?>
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth"><a>Nume Utilizator</a></th>
					<th class="table-header-repeat line-left minwidth"><a>Parola</a></th>
					<th class="table-header-repeat line-left minwidth"><a>Rol</a></th>
...
//error_reporting(E_ALL);
        ...
        if ($_SESSION['rol'] == 'user') {
            $result = mysql_query("SELECT * FROM useri WHERE id_user =" .$_SESSION['id_user']);
        } else {
			...
			//	echo mysql_errno() . ": " . mysql_error() . "\n";		
				...
				<tr>
					...
					<a href="editareCont.php?id_user=<?php echo $row['id_user']?>" title="Editare" id="<?=$row['id_user']?>" class="icon-1 info-tooltip"></a>
					<a href="../../BusinessLogic/sterge_cont.php?id_user=<?php echo $row['id_user']?>" title="Șterge" id="<?=$row['id_user']?>" class="icon-2 info-tooltip">
					</a>
					</td>
				</tr>
				<?php 
