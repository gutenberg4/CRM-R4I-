...
<div id="page-heading"><h1>Adaugă Produs</h1></div>
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
	<form  action="../../BusinessLogic/validare_produs.php" method="post">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top">Denumire:</th>
			<td style="padding-right: 150px"><input type="text" class="inp-form" name="nume"/>
			<a title="Denumirea completă a produsului." class="icon-1 info-tooltip">
			</a></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td style="padding-right: 150px"><input type="text" class="inp-form" name="pret"/><a title="Prețurile nu includ TVA, și se trec în RON" class="icon-1 info-tooltip">
			</a></td>
			
		</tr>
	<tr>
		<th valign="top">Descriere generală produs:</th>
		<td><textarea rows="" cols="" class="form-textarea" name="descriere"></textarea>
		</td>
	</tr>
	<tr>
		<th>&nbsp;</th>
