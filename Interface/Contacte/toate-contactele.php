			...
			?>
				...
				<tr>
				 <?php $sort = array_get($_GET, 'sort'); ?>
					<th class="table-header-repeat line-left minwidth <?php if ($sort == 'nume') echo "sort"; ?>"><a href="?sort=nume">Nume</a></th>
					<th class="table-header-repeat line-left minwidth"><a>Prenume</a></th>
					<th class="table-header-repeat line-left <?php if ($sort == 'companie') echo "sort"; ?>"><a href="?sort=companie">Companie</a></th>
...
error_reporting(E_ALL);
                ...
                $result = get_entries_for_current_page('contacte');
			//	echo mysql_errno() . ": " . mysql_error() . "\n";		
				...
				<tr>
					...
					<a href="editareContact.php?id_contact=<?php echo $row['id_contact']?>" title="Editare" id="<?=$row['id_contact']?>" class="icon-1 info-tooltip"></a>
					<a href="../../BusinessLogic/sterge_contact.php?id_contact=<?php echo $row['id_contact']?>" title="Șterge" id="<?=$row['id_contact']?>" class="icon-2 info-tooltip">
					</a>
					</td>
				</tr>
				<?php 
