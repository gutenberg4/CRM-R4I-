    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown active"><a href="#"><span class="iconfa-th-list"></span> Contacte</a>
                    <ul>
...
<div id="page-heading"><h1>Editare Contact</h1></div>
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
		<form  action="../../BusinessLogic/editare_contact.php" method="post">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<?php
				error_reporting(E_ALL);
require_once '../../config.php';
				//require_once '../config.php';
				$result = mysql_query("SELECT * FROM contacte WHERE id_contact=".$_GET['id_contact']."");
			...
			<tr>
				...
				<td><input type="text" class="inp-form" name="nume" value="<?=$row['nume']?>"/>
				</td>
				
			</tr>
			<tr>
				<th valign="top">Prenume:</th>
				<td><input type="text" class="inp-form" name="prenume" value="<?=$row['prenume']?>"/>
				</td>
				
			</tr>
			<tr>
				<th valign="top">Companie:</th>
				<td style="padding-right: 150px"><input type="text" class="inp-form" name="companie" value="<?=$row['companie']?>"/>
				<a title="Numele companiei din care face parte persoana de contact (poate fi client sau furnizor)." class="icon-1 info-tooltip">
			</a>
				</td>
				
			</tr>
			<tr>
				<th valign="top">Funcție:</th>
					<td style="padding-right: 150px"><input type="text" class="inp-form" name="functie" value="<?=$row['functie']?>"/>
					<a title="Funcția pe care o ocupă persoana de contact în cadrul companiei respective." class="icon-1 info-tooltip">
			</a>
					</td>
			...
			<tr>
				<th valign="top">Telefon:</th>
					<td><input type="text" class="inp-form" name="telefon" value="<?=$row['telefon']?>"/>
					</td>
					
			</tr>
			<tr>
				<th valign="top">E-mail:</th>
					<td><input type="text" class="inp-form" name="email" value="<?=$row['email']?>"/>
					</td>				
			</tr>
		<tr>
			<th valign="top">Observații:</th>
			<td><input type="text" class="inp-form" name="observatii" value="<?=$row['observatii']?>">
			</td>
			<input type="hidden" class="inp-form" name="id_contact" hidden value="<?=$row['id_contact']?>"/>
		</tr>
		<?php 
				}
				?>
