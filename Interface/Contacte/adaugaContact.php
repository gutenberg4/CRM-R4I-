...
<div id="page-heading"><h1>Adaugă Contact</h1></div>
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
		<form  action="../../BusinessLogic/validare_contact.php" method="post">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		
			<tr>
				<th valign="top">Nume:</th>
				<td><input type="text" class="inp-form" name="nume" />
				</td>
				
			</tr>
			<tr>
				<th valign="top">Prenume:</th>
				<td><input type="text" class="inp-form" name="prenume"/>
				</td>
				
			</tr>
			<tr>
				<th valign="top">Companie:</th>
				<td style="padding-right: 150px"><input type="text" class="inp-form" name="companie"/>
			...
			<tr>
				<th valign="top">Funcție:</th>
					<td style="padding-right: 150px"><input type="text" class="inp-form" name="functie"/>
			...
			<tr>
				<th valign="top">Telefon:</th>
					<td><input type="text" class="inp-form" name="telefon"/>
					</td>
					
			</tr>
			<tr>
				<th valign="top">E-mail:</th>
					<td><input type="text" class="inp-form" name="email"/>
					</td>				
			</tr>
		<tr>
			<th valign="top">Observații:</th>
			<td><textarea rows="" cols="" class="form-textarea" name="observatii"></textarea>
			</td>
		</tr>
