...
<div class="nav-outer"> 
	...
	<ul class="current"><li><a href="../Interface/Produse/toate-produsele.php"><b>Produse</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li class="sub_show"><a href="../Interface/Produse/toate-produsele.php">Vezi toate</a></li>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left"><a>Preț</a></th>
...
require_once '../config.php';
				$search=$_GET['search'];
				$result = mysql_query("SELECT * FROM `produse` WHERE nume='$search' OR domeniu='$search' OR pret='$search'");
		//		echo mysql_errno() . ": " . mysql_error() . "\n";		
				...
				<tr>
					...
					<a href="../Interface/Produse/editareProduse.php?id_produs=<? echo $row['id_produs'];?>" title="Editare" class="icon-1 info-tooltip"></a>
					<a href="sterge_produs.php?id_produs=<?php echo $row['id_produs']?>" title="Șterge" id="<?=$row['id_produs']?>" class="icon-2 info-tooltip">
					</a>
					</td>
				</tr>
				<?php 
