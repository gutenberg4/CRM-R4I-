...
<div class="nav-outer"> 
	...
	<ul class="select"><li><a href="../Interface/Produse/toate-produsele.php"><b>Produse</b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<ul class="current"><li><a href="../Interface/Furnizor/toti-furnizorii.php"><b>Furnizori</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li class="sub_show"><a href="../Interface/Furnizor/toti-furnizorii.php">Vezi toți</a></li>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a>Nume</a>	</th>
					<th class="table-header-repeat line-left minwidth-1"><a>Manager Cont</a></th>
					<th class="table-header-repeat line-left"><a>Domeniu</a></th>
					<th class="table-header-repeat line-left"><a>Website</a></th>
					<th class="table-header-repeat line-left"><a>Cifra afaceri</a></th>
...
require_once '../config.php';
				//require_once '../config.php';
				$search=$_GET['search'];
				$result = mysql_query("SELECT * FROM `furnizori` WHERE nume='$search' OR manager_cont='$search' OR domeniu='$search' 
				OR website='$search' OR cifra_afaceri='$search' OR persoana_contact='$search' OR telefon='$search' 
				OR email='$search' OR adresa='$search'");
			//	echo mysql_errno() . ": " . mysql_error() . "\n";		
				...
				<tr>
					...
					<a href="../Interface/Furnizor/editareFurnizor.php?id_furnizor=<? echo $row['id_furnizor'];?>" title="Editare" class="icon-1 info-tooltip"></a>
					<a href="sterge_furnizor.php?id_furnizor=<?php echo $row['id_furnizor']?>" title="Șterge" id="<?=$row['id_furnizor']?>" class="icon-2 info-tooltip">
					</a>
					</td>
				</tr>
				<?php 
