...
<div class="nav-outer"> 
	...
	<ul class="select"><li><a href="../Interface/Produse/toate-produsele.php"><b>Produse</b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<ul class="current"><li><a href="../Interface/Clienti/toti-clientii.php"><b>Clienți</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li class="sub_show"><a href="../Interface/Clienti/toti-clientii.php">Vezi toți</a></li>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					<th class="table-header-repeat line-left minwidth-1"><a>Nume Companie</a>	</th>
					...
					<th class="table-header-repeat line-left minwidth-1"><a>Cifra afaceri</a></th>
...
require_once '../config.php';
				//require_once '../config.php';
				$search=$_GET['search'];
				$result = mysql_query("SELECT * FROM `clienti` WHERE nume_companie='$search' OR manager_cont='$search' OR domeniu='$search'
		...
		//		echo mysql_errno() . ": " . mysql_error() . "\n";		
				...
				<tr>
					...
					<a href="../Interface/Clienti/editareClient.php?id_client=<? echo $row['id_client'];?>" title="Editare" class="icon-1 info-tooltip"></a>
					<a href="sterge_client.php?id_client=<?php echo $row['id_client']?>" title="Șterge" id="<?=$row['id_client']?>" class="icon-2 info-tooltip">
					</a>
					</td>
				</tr>
				<?php 
