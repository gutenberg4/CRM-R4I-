...
<div id="page-top">
	...
	<form method="post" >
		...
		<tr>
		<td><input type="text" id="search" name="search"  value="Search" onblur="if (this.value=='') { this.value='Search'; }" onfocus="if (this.value=='Search') { this.value=''; }" class="top-search-inp" />
		</td>
		<td>
...
<div class="nav-outer"> 
	...
	<ul class="select"><li><a href="../Interface/Produse/toate-produsele.php"><b>Produse</b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<ul class="current"><li><a href="../Interface/Contacte/toate-contactele.php"><b>Contacte</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li class="sub_show"><a href="../Interface/Contacte/toate-contactele.php">Vezi toate</a></li>
		...
		<ul class="select"><li><a href="../Interface/Intalniri/toate-intalnirile.php"><b>Întâlniri</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
					<li><a href="../Interface/Intalniri/toate-intalnirile.php">Vezi toate</a></li>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					<th class="table-header-repeat line-left minwidth"><a>Nume</a></th>
					<th class="table-header-repeat line-left minwidth"><a>Prenume</a></th>
					<th class="table-header-repeat line-left"><a>Companie</a></th>
					<th class="table-header-repeat line-left"><a>Funcție</a></th>
					<th class="table-header-repeat line-left"><a>Telefon</a></th>
					<th class="table-header-repeat line-left minwidth"><a>E-mail</a></th>
					<th class="table-header-repeat line-left minwidth-1"><a>Observații</a></th>
					<th class="table-header-options line-left minwidth"><a>Opțiuni</a></th>
				</tr>
				<?php
...
require_once '../config.php';
				$search=$_GET['search'];
				$result = mysql_query("SELECT * FROM `contacte` WHERE nume='$search' OR prenume='$search' OR companie='$search' OR functie='$search' OR email='$search'");
		//		echo mysql_errno() . ": " . mysql_error() . "\n";		
				...
				<tr>
					...
					<a href="../Interface/Contacte/editareContact.php?id_contact=<? echo $row['id_contact'];?>" title="Editare" class="icon-1 info-tooltip"></a>
					<a href="sterge_contact.php?id_contact=<?php echo $row['id_contact']?>" title="Șterge" id="<?=$row['id_contact']?>" class="icon-2 info-tooltip">
					</a>
					</td>
				</tr>
				<?php 
